# Loop 2 Design Brief — Compose install box + loopback search

| Field | Value |
|---|---|
| **Document** | MVP design for loop 2 (post-v1) |
| **Date** | 2026-09-11 |
| **Status** | Binding for P10+; do not implement from this file until Orchestrator opens `feature/P10-serve` |
