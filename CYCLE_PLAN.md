# CYCLE_PLAN.md — toponym (v1 `2026.09.09`, loop 2 `2026.09.11`, `2026.09.12`, `2026.09.13`)
...
| H | Посторонние деревья шаблонов не в git | `feature/nr-h-template` | DEC-TEMPLATE-001: не вендорить внешние шаблоны разработки | COMPLETE |
...
A–L COMPLETE на `main`. Annotated CalVer `2026.09.13` на `main`. Теги `2026.09.11` и `2026.09.12` не двигать.

## Definition of Done v1

- Все 25 resources из `datapackage.json` на диске.
