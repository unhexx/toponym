...
[![CalVer](https://img.shields.io/badge/CalVer-2026.09.17-informational.svg)](https://github.com/unhexx/toponym/releases/tag/2026.09.17)
...
Релиз: [`2026.09.17`](https://github.com/unhexx/toponym/releases/tag/2026.09.17). Лицензия репозитория: [MIT](LICENSE). Иходники — [`docs/SOURCES.md`](docs/SOURCES.md).
...
Обновление без компиляции (пин `ghcr.io/unhexx/toponym:2026.09.17`):
...
| [Релиз 2026.09.17](https://github.com/unhexx/toponym/releases/tag/2026.09.17) | тег и GitHub Release |
...
См. [`CITATION.cff`](CITATION.cff). Версия: `2026.09.17`.
