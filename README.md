...
[![CalVer](https://img.shields.io/badge/CalVer-2026.09.25-informational.svg)](https://github.com/unhexx/toponym/releases/tag/2026.09.25)
...
Релиз: [`2026.09.25`](https://github.com/unhexx/toponym/releases/tag/2026.09.25). Лицензия репозитория: [MIT](LICENSE). Иходники — [`docs/SOURCES.md`](docs/SOURCES.md).
...
Обновление без компиляции (пин `ghcr.io/unhexx/toponym:2026.09.25`):
...
| [Релиз 2026.09.25](https://github.com/unhexx/toponym/releases/tag/2026.09.25) | тег и GitHub Release |
...
|---|---|---|---|
| Wikidata | Q-id, имена, P625 | CC0 | harvest мест (не «все X России») |
...
См. [`CITATION.cff`](CITATION.cff). Версия: `2026.09.25`.
