...
Релиз: [`2026.09.14`](https://github.com/unhexx/toponym/releases/tag/2026.09.14). Лицензия репозитория: [MIT](LICENSE). Сырьё источников хранит свои лицензии — [`docs/SOURCES.md`](docs/SOURCES.md).
