...
**Version Target:** v1 `2026.09.09`; loop 2 `2026.09.11`; текущий тег `2026.09.17`.
...
Keep-out A–L COMPLETE на `main` (`CYCLE_PLAN.md`). Живой backlog: GitHub #13. Не retcon v1 non-goals. Теги `2026.09.11`, `2026.09.12`, `2026.09.13`, `2026.09.14`, `2026.09.15` и `2026.09.16` не двигать; текущий — `2026.09.17`.
