...
Дромонимы и сёла — малые сиды (DEC-SEED-002), не ГАР. Типы уже были в `types.csv`.

| Таблица | Сколько строк | Примеры |
|---|---|---|
| `data/curated/agoronyms.csv` | сотни (Wikidata Q174782, не ОМК УМ) | Красная площадь, Дворцовая площадь |
| `data/curated/dromonyms.csv` | сид (DEC-SEED-002) | Транссибирская магистраль (Транссиб), М11 «Нева» |
...
и дромонимов / сёл (DEC-SEED-002; не ГАР).
