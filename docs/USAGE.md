...
Муниципалитеты и микротопонимы — **малые сиды** (DEC-SEED-001), не выгрузка ГАР.
Годонимы (DEC-SEED-003) — реестр улиц Wikidata (CC0): P31=Q79007, P17=Q159,
upsert по `wd:Q…`. Это не ФИАС и не все улицы России; SPARQL JSON в git нет.
