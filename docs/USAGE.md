...
Муниципалитеты — реестр МО Wikidata (CC0): P31 городской округ / муниципальный округ / район /
...
Микротопонимы — **малые сиды** (DEC-SEED-001), не выгрузка ГКГН.
...
реестр муниципалитетов и годонимов Wikidata, малые сиды микротопонимов (десятки строк, DEC-SEED-001) и дромонимов / сёл / площадей (DEC-SEED-002; не ГАР).
