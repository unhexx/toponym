...
Микротопонимы: `data/curated/microtoponyms.csv` — Wikidata parks+caves+овраг+урочище+поле (P17=Q159), плюс курируемые extras (леса, бархан, Провал) не как массовые классы; не ГКГН и не все микротопонимы России.
