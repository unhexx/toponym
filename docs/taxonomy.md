...
Муниципалитеты: `data/curated/municipalities.csv` — МО Wikidata (P31 городской округ / округ / район / поселение / внутригородское, P17=Q159), не полный ОКТМО и не все МО России.

Малые сиды (DEC-SEED-001, не дамп ГКГН): `data/curated/microtoponyms.csv` — десятки строк Wikidata CC0, не полный реестр урочищ.
